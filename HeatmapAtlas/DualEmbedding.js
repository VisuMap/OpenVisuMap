...
cfg = {...cfg, ...{
	...
	Exa:    PP(6,     6),       // initial exaggreation
	ExaF:   PP(1.0,   1.0),     // final exaggeration.
	Ppr:    PP(0.1,   0.1),     // perplexity ratio    
 	PrShift:PP(0,     0),       // cell/gene profile shift towards arithmetric center.
	Mtr:	PP(cfg.cos, cfg.euc),
	Is3D:	PP(false,   false),
	cellMap:null, 
	geneMap:null,
	hpSize: 400,
